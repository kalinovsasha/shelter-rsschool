...
//let pet = JSON.parse(modalPets)[4]; // Для тестов
...
let modalWindow = {
    ...
    setPet(pet){
        this.img.src=pet.img;
        this.petName.innerHTML=pet.name;
        this.petType.innerHTML=`${pet.type} - ${pet.breed}`;
        this.petDescription.innerHTML=pet.description;
        this.petAge.innerHTML=`<b>Age:</b> ${pet.age}`;
        this.Inoculations.innerHTML=`<b>Inoculations:</b>  ${pet.inoculations}`;
        this.Diseases.innerHTML=`<b>Diseases:</b> ${pet.diseases}`;
